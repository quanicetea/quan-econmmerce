        ...
        <main>
            <table>
                <thead>
                    ...
                    {{-- <th class="product sp">{{trans('order::orders.order-detail.shop')}}</th> --}}
                ...
                <tbody>
                    ...
                    @if($orderItem->product->user->id == $user->id)
                    <tr>
                        
                        <td class="service product flag stt">#{{$stt+1}}</td>
                        ...
                        {{-- <td class=" product flag">{{$orderItem->product->user->first_name.' '.$orderItem->product->user->last_name}}</td> --}}
                    ...
                    <tr>
                        ...
                        <td class=" product tt">{{number_format($subtotal)}}</td>
                    </tr>
                    {{-- <tr>
                    ...
                    <tr>
                        ...
                        <td class="grand total product tt">{{number_format($subtotal)}}</td>
                    </tr>
                </tbody>
            </table>
            {{-- <div id="notices">
